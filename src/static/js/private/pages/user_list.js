...
function get_img_by_user_right(user_right, need_right) {
    var img = '';
    if ((user_right & need_right) !== 0) {
        img = '<img src="/static/images/ok.png" alt="是"/>';
    }
